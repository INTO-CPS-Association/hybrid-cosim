...
DYMOLA_STATIC2 Integer Integerbuffer[50000];
DYMOLA_STATIC2 SizeType Sizebuffer[50000];
DYMOLA_STATIC2 String Stringbuffer[10000];
DYMOLA_STATIC2 char simplestring[100000];
...
DYMOLA_STATIC2 Integer IntegerbufferNon[50000];
DYMOLA_STATIC2 SizeType SizebufferNon[50000];
DYMOLA_STATIC2 String StringbufferNon[10000];
DYMOLA_STATIC2 char simplestringNon[1000];
...
DYMOLA_STATIC String Real2String(Real x,Integer precision,Integer minwidth);
DYMOLA_STATIC String Integer2String(Integer x,Integer precision,Integer minwidth);
